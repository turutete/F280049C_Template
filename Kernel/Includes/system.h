...
#define LSXACCPROT0    ((LS3_WCPU_BLOCKED<<1|LS3_PROGCPU_BLOCKED)<<24)|((LS2_WCPU_BLOCKED<<1|LS2_PROGCPU_BLOCKED)<<16)|((LS1_WCPU_BLOCKED<<1|LS1_PROGCPU_BLOCKED)<<8)|((LS0_WCPU_BLOCKED<<1|LS0_PROGCPU_BLOCKED)<<24)
#define LSXACCPROT1    ((LS7_WCPU_BLOCKED<<1|LS7_PROGCPU_BLOCKED)<<24)|((LS6_WCPU_BLOCKED<<1|LS6_PROGCPU_BLOCKED)<<16)|((LS5_WCPU_BLOCKED<<1|LS5_PROGCPU_BLOCKED)<<8)|((LS4_WCPU_BLOCKED<<1|LS4_PROGCPU_BLOCKED)<<24)
